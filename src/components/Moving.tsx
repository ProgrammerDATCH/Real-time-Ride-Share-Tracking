...
export const Moving = () => {
  ...
  return (
    <div className='bg-gradient-to-r from-cyan-500 to-green-500 w-full h-full'>
        ...
        <div className="route-details flex flex-col bg-white p-0 text-lg h-2/5">
            ...
            <span>instruction: {!instruction ? "Loading..." : instruction}</span>
            <span>Status: {!status ? "Loading..." : status}</span>
        </div>
        <div className="map flex justify-center h-2/5">
            <MapComponent setRouteInfo={setRouteInfo} setStatus={setStatus} setInstruction={setInstruction}/>
        </div>
